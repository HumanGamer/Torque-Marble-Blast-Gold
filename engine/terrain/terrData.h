...
//CW - end bump mapping stuff
   ...
   S32 mMPMIndex[10]; // Whoever put in this magic number should die, in the face
                      // What is this constant? And why can't it be changed without 
                      // screwing up the findSquare in rebuildEmptyFlags? -pw
